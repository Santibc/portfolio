...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Validacion de Idioma en Espanol
    |--------------------------------------------------------------------------
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado ha aparecido en una filtracion de datos. Por favor elija un :attribute diferente.',
    ],
