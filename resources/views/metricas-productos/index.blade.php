  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const table = $('#metricas-table').DataTable({
      ...
      columns: [
        ...
        { data: 'stock_badge',      name: 'stock_badge', className: 'text-center' },
        { data: 'unidades',         name: 'unidades', className: 'text-end' },
        { data: 'ingresos_fmt',     name: 'ingresos_fmt', className: 'text-end' },
        { data: 'transacciones',    name: 'transacciones', className: 'text-end' },
        { data: 'precio_prom_fmt',  name: 'precio_prom_fmt', className: 'text-end' },
        { data: 'ultima_venta_fmt', name: 'ultima_venta_fmt' },
        { data: 'delta_badge',      name: 'delta_badge', className: 'text-center' },
      ],
