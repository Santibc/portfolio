        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="hero-content">
              ...
              <p>{{ $homeConfig->hero_description ?? 'At Clean Me, we believe that putting in a lot of hard work ensures the best and fastest service.' }}</p>
              <div class="hero-actions justify-content-center justify-content-lg-start">
                <a href="{{ $homeConfig->hero_services_button_url ?? route('servicios') }}" class="btn-primary">Our Services</a>
                <a href="{{ $homeConfig->hero_estimate_button_url ?? '#contact' }}" class="btn-primary scrollto">Get Free Estimate</a>
              </div>
          ...
          <div class="col-lg-6">
            <div class="hero-image">
              <img src="{{ $homeConfig && $homeConfig->hero_image_path ? asset($homeConfig->hero_image_path) : asset('images/mujer.png') }}" class="img-fluid floating" alt="Clean Me Services">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="about-image">
              <img src="{{ $homeConfig && $homeConfig->about_image_path ? asset($homeConfig->about_image_path) : asset('images/paginaanterior/imagenluegodeltitulo.avif') }}" alt="{{ $homeConfig->about_title ?? 'We Are Clean Me' }}" class="img-fluid">
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="content">
              ...
              <p class="lead">{{ $homeConfig->about_lead ?? 'Excellence and professionalism are first when it comes to our Residential and Commercial Cleaning Services.' }}</p>

              <p>{{ $homeConfig->about_description ?? 'We are constantly improving our services, staying up-to-date on all the latest industry advancements, and bringing our knowledge to your doorstep.' }}</p>

              <!-- Stats Row -->
              <div class="stats-row">
                <div class="stat-item">
                  <h3><span data-purecounter-start="0" data-purecounter-end="{{ $homeConfig->about_years_experience ?? 16 }}" data-purecounter-duration="1" class="purecounter"></span>+</h3>
                  <p>Years Experience</p>
                </div>
                <div class="stat-item">
                  <h3><span data-purecounter-start="0" data-purecounter-end="{{ $homeConfig->about_happy_clients ?? 500 }}" data-purecounter-duration="1" class="purecounter"></span>+</h3>
                  <p>Happy Clients</p>
                </div>
                <div class="stat-item">
                  <h3><span data-purecounter-start="0" data-purecounter-end="{{ $homeConfig->about_client_satisfaction ?? 100 }}" data-purecounter-duration="1" class="purecounter"></span>%</h3>
