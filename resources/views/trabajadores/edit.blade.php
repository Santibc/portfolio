...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h1 class="h3 mb-1">Editar Trabajador</h1>
                <p class="text-muted mb-0">{{ $trabajador->nombre_completo }}</p>
            </div>
        </div>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="tipo_relacion" id="tipoRelacion" class="form-select @error('tipo_relacion') is-invalid @enderror" required onchange="toggleSubcontrata()">
                            <option value="propio" {{ old('tipo_relacion', $trabajador->tipo_relacion) === 'propio' ? 'selected' : '' }}>Propio</option>
                            <option value="subcontrata" {{ old('tipo_relacion', $trabajador->tipo_relacion) === 'subcontrata' ? 'selected' : '' }}>Subcontrata</option>
                        </select>
                        @error('tipo_relacion')
                    ...
                    <!-- Subcontrata -->
                    <div class="col-md-6" id="subcontrataContainer" style="{{ old('tipo_relacion', $trabajador->tipo_relacion) === 'subcontrata' ? '' : 'display: none;' }}">
                        ...
                        <select name="subcontrata_id" id="subcontrataId" class="form-select @error('subcontrata_id') is-invalid @enderror">
                            ...
                            @foreach($subcontratas as $subcontrata)
                                <option value="{{ $subcontrata->id }}" {{ old('subcontrata_id', $trabajador->subcontrata_id) == $subcontrata->id ? 'selected' : '' }}>
                                    {{ $subcontrata->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="apellidos" class="form-control @error('apellidos') is-invalid @enderror"
                               value="{{ old('apellidos', $trabajador->apellidos) }}" required>
                        @error('apellidos')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="dni" class="form-control @error('dni') is-invalid @enderror"
                               value="{{ old('dni', $trabajador->dni) }}" required>
                        @error('dni')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="fecha_alta" class="form-control @error('fecha_alta') is-invalid @enderror"
                               value="{{ old('fecha_alta', $trabajador->fecha_alta?->format('Y-m-d')) }}" required>
                        @error('fecha_alta')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="categoria_convenio" class="form-control @error('categoria_convenio') is-invalid @enderror"
                               value="{{ old('categoria_convenio', $trabajador->categoria_convenio) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="cuadrilla_id" class="form-select @error('cuadrilla_id') is-invalid @enderror">
                            ...
                            @foreach($cuadrillas as $cuadrilla)
                                <option value="{{ $cuadrilla->id }}" {{ old('cuadrilla_id', $cuadrillaActual?->id) == $cuadrilla->id ? 'selected' : '' }}>
                                    {{ $cuadrilla->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <!-- Datos económicos -->
                    <div class="col-12" id="datosEconomicosHeader" style="{{ old('tipo_relacion', $trabajador->tipo_relacion) === 'subcontrata' ? 'display: none;' : '' }}">
                        <hr class="my-2">
                        <h6 class="text-muted fw-semibold">DATOS ECONÓMICOS</h6>
                    </div>

                    <div class="col-md-3" id="salarioContainer" style="{{ old('tipo_relacion', $trabajador->tipo_relacion) === 'subcontrata' ? 'display: none;' : '' }}">
                        ...
                        <div class="input-group">
                            <input type="number" name="salario_bruto_mensual" class="form-control @error('salario_bruto_mensual') is-invalid @enderror"
                                   value="{{ old('salario_bruto_mensual', $trabajador->salario_bruto_mensual) }}" step="0.01" min="0">
                    ...
                    <div class="col-md-3" id="costeDiaContainer" style="{{ old('tipo_relacion', $trabajador->tipo_relacion) === 'subcontrata' ? 'display: none;' : '' }}">
                        ...
                        <div class="input-group">
                            <input type="number" name="coste_empresa_dia" class="form-control @error('coste_empresa_dia') is-invalid @enderror"
                                   value="{{ old('coste_empresa_dia', $trabajador->coste_empresa_dia) }}" step="0.01" min="0">
                            <span class="input-group-text">€</span>
                    ...
                    <div class="col-md-3" id="costeHoraContainer" style="{{ old('tipo_relacion', $trabajador->tipo_relacion) === 'subcontrata' ? 'display: none;' : '' }}">
                        ...
                        <div class="input-group">
                            <input type="number" name="coste_hora" class="form-control @error('coste_hora') is-invalid @enderror"
                                   value="{{ old('coste_hora', $trabajador->coste_hora) }}" step="0.01" min="0">
                            <span class="input-group-text">€</span>
                            @error('coste_hora')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-3" id="vacacionesContainer" style="{{ old('tipo_relacion', $trabajador->tipo_relacion) === 'subcontrata' ? 'display: none;' : '' }}">
                        ...
                        <div class="input-group">
                            <input type="number" name="vacaciones_anuales" class="form-control @error('vacaciones_anuales') is-invalid @enderror"
                                   value="{{ old('vacaciones_anuales', $trabajador->vacaciones_anuales) }}" min="0">
                    ...
                    <div class="col-12">
                        <hr class="my-2">
                        <h6 class="text-muted fw-semibold">ESTADO</h6>
                    </div>

                    <div class="col-md-4">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="activo" id="activo" value="1"
                                   {{ old('activo', $trabajador->activo) ? 'checked' : '' }}>
