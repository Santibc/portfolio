<div class="d-flex flex-column h-100">
  ...
  <div class="sidebar-header">
    <a href="{{ url('/') }}" class="sidebar-logo">
      ...
      <i class="bi bi-flower1 sidebar-logo-icon" style="font-size: 28px; color: #1a1a1a;"></i>
    </a>
  </div>
  ...
  <nav class="sidebar-nav">
    ...
    <div class="sidebar-submenu-container">
      <a href="#armaTuRamoMenu"
        class="sidebar-link {{ request()->routeIs('flores.*') || request()->routeIs('estilos-ramo.*') || request()->routeIs('envolturas-ramo.*') ? 'active' : '' }}"
        data-bs-toggle="collapse"
        aria-expanded="{{ request()->routeIs('flores.*') || request()->routeIs('estilos-ramo.*') || request()->routeIs('envolturas-ramo.*') ? 'true' : 'false' }}"
        title="Arma tu Ramo">
        <i class="bi bi-flower2"></i>
        <span>Arma tu Ramo</span>
        <i class="bi bi-chevron-down sidebar-chevron"></i>
      </a>
      <div class="collapse {{ request()->routeIs('flores.*') || request()->routeIs('estilos-ramo.*') || request()->routeIs('envolturas-ramo.*') ? 'show' : '' }}" id="armaTuRamoMenu">
        <div class="sidebar-submenu">
