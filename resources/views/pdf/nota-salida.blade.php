...
<head>
    <meta charset="UTF-8">
    <title>Nota de Salida {{ $numero }}</title>
    <style>
        body {
            ...
            <tr>
                <td style="width: 50%;">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><span class="badge-salida">SALIDA</span></span>
                    </div>
                    <div class="info-row">
    ...
    <table class="detail-table">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; color: #dc3545; font-size: 16px;">
                    -{{ $movimiento->cantidad }}
                </td>
