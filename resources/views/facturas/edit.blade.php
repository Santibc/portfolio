                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            <textarea name="footer_text" id="footer_text"
                                      ...
                                      rows="2"
                                      maxlength="1000"
                                      placeholder="Texto del pie de página para el PDF...">{{ old('footer_text', $factura->footer_text) }}</textarea>
                            @error('footer_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="d-flex justify-content-between">
                            ...
                            <small class="text-muted">
                                <span id="charCount">{{ strlen(old('footer_text', $factura->footer_text)) }}</span>/1000 caracteres
                            </small>
                        </div>
                    </div>
                </div>
