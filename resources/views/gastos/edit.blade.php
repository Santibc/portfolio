        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        @php
                            $desglose = $gasto->desglose_iva ?: [['base' => $gasto->importe, 'porcentaje' => $gasto->iva_porcentaje]];
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" name="irpf_porcentaje" id="irpf_porcentaje" class="form-control" step="0.01" min="0" max="100" value="{{ old('irpf_porcentaje', $gasto->irpf_porcentaje) }}">
                                    <span class="input-group-text">%</span>
                                </div>
