                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" name="importe" id="importe" class="form-control @error('importe') is-invalid @enderror"
                                           value="{{ old('importe', $ingreso->importe) }}" required min="0.01" step="0.01" placeholder="0,00">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="iva_porcentaje" id="iva_porcentaje" class="form-select @error('iva_porcentaje') is-invalid @enderror" required>
                                    <option value="0" {{ old('iva_porcentaje', $ingreso->iva_porcentaje) == '0' ? 'selected' : '' }}>0%</option>
                                    <option value="4" {{ old('iva_porcentaje', $ingreso->iva_porcentaje) == '4' ? 'selected' : '' }}>4%</option>
                                    <option value="10" {{ old('iva_porcentaje', $ingreso->iva_porcentaje) == '10' ? 'selected' : '' }}>10%</option>
                                    <option value="21" {{ old('iva_porcentaje', $ingreso->iva_porcentaje) == '21' ? 'selected' : '' }}>21%</option>
                                </select>
