...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">Nuevo Vehículo</h1>
            <p class="text-muted mb-0">Registra un nuevo vehículo en la flota</p>
        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="matricula" class="form-control @error('matricula') is-invalid @enderror"
                                       value="{{ old('matricula') }}" placeholder="Ej: 1234 ABC" required style="text-transform: uppercase;">
                                @error('matricula')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="marca" class="form-control @error('marca') is-invalid @enderror"
                                       value="{{ old('marca') }}" placeholder="Ej: Ford, Renault, Mercedes...">
                                @error('marca')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="modelo" class="form-control @error('modelo') is-invalid @enderror"
                                       value="{{ old('modelo') }}" placeholder="Ej: Transit, Master...">
                                @error('modelo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="numero_bastidor" class="form-control"
                                       value="{{ old('numero_bastidor') }}" placeholder="VIN / Número de bastidor">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="compania_seguro" class="form-control"
                                       value="{{ old('compania_seguro') }}" placeholder="Ej: Mapfre, AXA, Allianz...">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Número de Póliza</label>
                                <input type="text" name="numero_poliza" class="form-control"
                                       value="{{ old('numero_poliza') }}" placeholder="Número de póliza">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="coste_dia" class="form-control"
                                       value="{{ old('coste_dia') }}" step="0.01" min="0"
                                       placeholder="0.00">
                        ...
                        <div>
                            ...
                            <div class="input-group">
                                <input type="number" name="kilometraje_actual" class="form-control"
                                       value="{{ old('kilometraje_actual') }}" min="0"
                                       placeholder="0">
                    ...
                    <div class="card-body">
                        ...
                        <select name="conductor_habitual_id" class="form-select">
                            ...
                            @foreach($conductores as $conductor)
                                <option value="{{ $conductor->id }}" {{ old('conductor_habitual_id') == $conductor->id ? 'selected' : '' }}>
