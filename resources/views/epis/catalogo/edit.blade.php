...
@section('title', 'Editar Tipo de EPI')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">Editar Tipo de EPI</h1>
            <p class="text-muted mb-0">{{ $epiCatalogo->nombre }}</p>
        </div>
    ...
    <form action="{{ route('epi-catalogo.update', $epiCatalogo) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row g-4">
            <!-- Columna Principal -->
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                                       value="{{ old('nombre', $epiCatalogo->nombre) }}"
                                       placeholder="Ej: Casco de seguridad, Arnes anticaidas..." required>
                                @error('nombre')
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="categoria" class="form-control @error('categoria') is-invalid @enderror"
                                       value="{{ old('categoria', $epiCatalogo->categoria) }}" list="categorias-list"
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="tiene_caducidad" value="1"
                                           id="tiene_caducidad" {{ old('tiene_caducidad', $epiCatalogo->tiene_caducidad) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="requiere_revision" value="1"
                                           id="requiere_revision" {{ old('requiere_revision', $epiCatalogo->requiere_revision) ? 'checked' : '' }}
                            ...
                            <div class="col-md-6" id="periodicidad-container" style="{{ old('requiere_revision', $epiCatalogo->requiere_revision) ? '' : 'display: none;' }}">
                                ...
                                <input type="number" name="periodicidad_revision_meses"
                                       ...
                                       value="{{ old('periodicidad_revision_meses', $epiCatalogo->periodicidad_revision_meses ?? 12) }}" min="1" max="60"
                                       placeholder="Ej: 12">
                ...
                <div class="card border-0 shadow-sm mt-4">
                    ...
                    <div class="card-body">
                        <p class="small text-muted mb-2">
                            <strong>Creado:</strong> {{ $epiCatalogo->created_at->format('d/m/Y H:i') }}
                        </p>
                        @if($epiCatalogo->updated_at && $epiCatalogo->updated_at != $epiCatalogo->created_at)
                        <p class="small text-muted mb-0">
                            <strong>Modificado:</strong> {{ $epiCatalogo->updated_at->format('d/m/Y H:i') }}
                        </p>
                        @endif
                    </div>
                </div>
