            ...
            <div class="modal-body">
                <nav class="mobile-nav">
                    <ul class="mobile-nav-list">
                        <li class="mobile-nav-item"><a href="{{ route('tienda.empresa', $empresa->slug) }}" class="mobile-nav-link">Inicio</a></li>
                        ...
                        <li class="mobile-nav-item">
                            ...
                            <ul class="mobile-nav-sublist">
                                ...
                                <li class="mobile-nav-subitem">
                                    <a href="{{ route('tienda.categorias', [$empresa->slug, 'categoria' => $categoria->id]) }}" class="mobile-nav-link">{{ $categoria->nombre }}</a>
                                </li>
                                @endforeach
                            </ul>
                        </li>
