        ...
        <div class="slider-wrapper">
            <div class="slider-track">
                ...
                <div class="slide">
                    @if($imagen->link)
                        <a href="{{ $imagen->link }}">
                            <img src="{{ $imagen->imagen_url }}" alt="{{ $imagen->titulo ?? 'Slide ' . $loop->iteration }}" loading="lazy">
                        </a>
                    @else
                        <img src="{{ $imagen->imagen_url }}" alt="{{ $imagen->titulo ?? 'Slide ' . $loop->iteration }}" loading="lazy">
                    @endif
            ...
            <div class="js-products-featured-col col-12">
                ...
                <div class="js-products-featured-grid row row-grid" data-desktop-columns="6" data-mobile-columns="2" data-desktop-format="grid" data-mobile-format="grid" data-mobile-slider-columns="2.25">
                    @forelse($productos as $producto)
                        ...
                        @endphp
                        <div class="js-item-product col-6 col-md-2 item-product col-grid" data-product-type="list" data-product-id="{{ $producto->id }}" data-store="product-item-{{ $producto->id }}">
                            <div class="item">
...
<section class="section-home section-welcome section-home-color section-welcome-home-colors section-welcome-animated" data-store="home-welcome-message">
    <div class="js-welcome-animated welcome-animated" style="animation: 118.175s linear 0s infinite normal none running marquee;">
        <a href="/">
    ...
    <div class="container">
        ...
        <div class="recife-categories-grid">
            ...
            <div class="recife-category-card">
                <a href="{{ route('tienda.categorias', [$empresa->slug, 'categoria' => $categoria->id]) }}" class="recife-category-link">
                    <div class="recife-category-image">
                        @if($categoria->imagen)
                            <img src="{{ asset($categoria->imagen) }}" alt="{{ $categoria->nombre }}" loading="lazy">
                        @else
                            <img src="https://via.placeholder.com/400x120/f0f0f0/666666?text={{ urlencode($categoria->nombre) }}" alt="{{ $categoria->nombre }}" loading="lazy">
                        @endif
...
<section class="js-section-products-offers section-home section-featured-home section-offers-products-home" data-store="home-products-offers">
    <div class="js-products-offers-container container">
        <div class="row">
            <div class="js-products-offers-col col-12">
                ...
                <div class="js-products-offers-grid row row-grid" data-desktop-columns="6" data-mobile-columns="2" data-desktop-format="grid" data-mobile-format="grid" data-mobile-slider-columns="2.25">
                                            ...
                                            <div class="item-price-container" data-store="product-item-price-{{ $producto->id }}">
                                                <div class="d-block mb-1 mr-1">
                                                    @if($precioNumerico)
                                                        ...
                                                        <span class="js-price-display item-price font-weight-bold text-accent" data-product-price="{{ $precioConDescuento * 100 }}">
...
<section class="section-home section-instagram-home" data-store="home-instagram" >
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="instagram-box" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; padding: 30px 20px; text-align: center; box-shadow: 0 5px 20px rgba(102, 126, 234, 0.25);">
                    <div class="instagram-content">
                        <!-- Icono de Instagram -->
                        <div class="instagram-icon mb-3">
                            <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="2" y="2" width="20" height="20" rx="5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <!-- Descripción -->
                        <p class="text-white mb-3" style="font-size: 0.9rem; opacity: 0.9; max-width: 500px; margin-left: auto; margin-right: auto;">
                        ...
                        @php
                            ...
                            $instagramHandle = $empresa->instagram ?? $empresa->nombre_fantasia ?? $empresa->nombre;
                            ...
                            if (!empty($empresa->instagram)) {
                                ...
                                $instagramUrl .= str_replace(' ', '', strtolower($empresa->nombre_fantasia ?? $empresa->nombre));
                            }
                        @endphp
                        <div class="instagram-handle mb-2">
                            <span class="h6 text-white" style="font-weight: 600; letter-spacing: 0.5px; font-size: 0.95rem;">
                                {{ $instagramHandle }}
                            </span>
                        </div>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .instagram-box h2, .instagram-box .h3 {
