...
:root {
  ...
  --section-negative-distance: calc((var(--section-distance) - 10px) * -1);
        ...
        <style>
            /* CSS personalizado para topbar más delgado */
            .section-topbar {
            ...
            .section-topbar .col,
            .section-topbar .col-auto {
                padding-top: 0 !important;
                padding-bottom: 0 !important;
            }

            .section-topbar .head-banners {
            ...
            .section-topbar .topbar-icon {
                width: 14px !important;
                height: 14px !important;
            }

            .section-topbar .col.pl-2 {
...
<header class="js-head-main head-main head-colors position-sticky position-sticky-md head-logo-left head-logo-md-left head-nav-md-inline header-with-adbar transition-soft" data-store="head" style="top: 0px;">
	...
	<div class="js-topbar section-topbar d-none d-md-block">
		<div class="container">
			<div class="row align-items-center justify-content-end h-100">
				<div class="col">
					@if($empresa->telefono || $empresa->whatsapp)
						<span style="color: var(--topbar-foreground); font-size: 13px;">
							¿Necesitas ayuda?
							@if($empresa->whatsapp)
								<a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $empresa->whatsapp) }}"
								   target="_blank"
								   class="secondary-menu-link"
								   style="margin-left: 5px; color: var(--topbar-foreground);">
									{{ $empresa->whatsapp }}
								</a>
...
<div id="logo" class="logo-img-container ">
    <a href="{{ route('tienda.empresa', $empresa->slug) }}" title="{{ $empresa->nombre }}">
    	@if($empresa->logo_url)
    		<img src="{{ $empresa->logo_url }}" alt="{{ $empresa->nombre }}" class="logo-img transition-soft " style="max-height: 80px;">
    	@else
    		<h1 style="font-size: 36px; font-weight: 600; margin: 0; color: var(--header-foreground);">{{ $empresa->nombre }}</h1>
    	@endif
    </a>
    ...
    <ul class="js-nav-desktop-list nav-desktop-list" data-store="navigation" data-component="menu">
        <span class="js-nav-desktop-list-arrow js-nav-desktop-list-arrow-left nav-desktop-list-arrow nav-desktop-list-arrow-left disable" style="display: none">
			...
			<li class="js-desktop-nav-item js-item-subitems-desktop nav-item-desktop js-nav-main-item nav-dropdown nav-main-item nav-item item-with-subitems" data-component="menu.item">
						<div class="nav-item-container">
							<a class=" nav-list-link position-relative  " href="{{ route('tienda.categorias', $empresa->slug) }}">Categorías
									</a>
						</div>
					...
					<div class="container desktop-dropdown-container">
							...
							@foreach($categorias as $categoria)
								<li class="js-desktop-nav-item nav-item-desktop nav-item" data-component="menu.item">
									<a class="nav-list-link" href="{{ route('tienda.categorias', [$empresa->slug, 'categoria' => $categoria->id]) }}">{{ $categoria->nombre }}</a>
								</li>
							@endforeach
		...
		<a href="#" class="js-search-button js-modal-open js-fullscreen-modal-open btn btn-utility utilities-item" data-modal-url="modal-fullscreen-search" data-toggle="#nav-search" aria-label="Buscador">
			<svg class="icon-inline align-bottom utilities-icon"><use xlink:href="#search"></use></svg>
                                    ...
                                    </div><div class="js-utility-col col-auto col-utility desktop-utility-col order-2" style="visibility: visible; height: auto;">
                    	<span class="utilities-container d-inline-block">
		<div id="ajax-cart" class="cart-summary" data-component="cart-button">
			<a href="{{ route('tienda.carrito', $empresa->slug) }}">
				<svg class="icon-inline utilities-icon cart-icon mr-md-1"><use xlink:href="#cart"></use></svg>
				<span class="js-cart-widget-amount badge">@if($carrito->total_items > 0){{ $carrito->total_items }} @else 0 @endif</span>
			</a>
		</div>
	</span>
                </div>
...
<div id="nav-hamburger" class="js-modal   modal modal-nav-hamburger modal-docked-md pb-0 modal-left modal--md transition-slide modal-full transition-soft " style="display: none;">
            ...
            <div class="modal-scrollable-area">
                ...
                <div class="modal-body nav-body">		<div class="nav-secondary row no-gutters pl-3 align-items-center justify-content-end" data-store="account-links">
...
<div class="nav-primary">
    <ul class="nav-list" data-store="navigation" data-component="menu">
			...
			<li class=" nav-item item-with-subitems" data-component="menu.item">
							<a class="js-toggle-menu-panel align-items-center nav-list-link position-relative  " href="#">Categorías
							...
							<svg class="icon-inline icon-lg svg-icon-text"><use xlink:href="#arrow"></use></svg>
								...
								<div class="modal-body p-0">
											...
											<a class="nav-list-link position-relative font-small py-3 " href="{{ route('tienda.categorias', $empresa->slug) }}">
...
<footer class="js-footer js-hide-footer-while-scrolling footer-colors display-when-content-ready overflow-none" data-store="footer">
	<div class="container py-3">
		<div class="row">
				...
				<div class="js-accordion-private-content js-accordion-private-content-mobile">
					<ul class="list py-2 font-small">
						<li class="footer-menu-item">
							<a class="footer-menu-link" href="{{ route('tienda.categorias', $empresa->slug) }}">Todos los productos</a>
						</li>
						@if(isset($categorias) && $categorias->count() > 0)
							@foreach($categorias->take(5) as $categoria)
								<li class="footer-menu-item">
									<a class="footer-menu-link" href="{{ route('tienda.categorias', [$empresa->slug, 'categoria' => $categoria->id]) }}">{{ $categoria->nombre }}</a>
								</li>
							@endforeach
						@endif
					</ul>
			...
			<div class="js-accordion-private-container accordion col-md">
				<a class="js-accordion-private-toggle-mobile row align-items-center" style="cursor: default;">
					<div class="font-big col p-3">HORARIO</div>
					<div class="d-md-none col-auto icon-48px">
						<span class="js-accordion-private-toggle-inactive">
							<svg class="icon-inline icon-lg"><use xlink:href="#plus"></use></svg>
						</span>
				...
				<div class="js-accordion-private-content js-accordion-private-content-mobile">
					...
					@else
						<p style="opacity: 0.8; font-size: 14px; padding: 8px 0;">Lun - Vie: 9:00 - 18:00</p>
					@endif
				</div>
			</div>
			...
			<div class="js-accordion-private-container accordion col-md">
				<a class="js-accordion-private-toggle-mobile row align-items-center" style="cursor: default;">
					<div class="font-big col p-3">REDES SOCIALES</div>
					<div class="d-md-none col-auto icon-48px">
						<span class="js-accordion-private-toggle-inactive">
							<svg class="icon-inline icon-lg"><use xlink:href="#plus"></use></svg>
						</span>
				...
				<div class="js-accordion-private-content js-accordion-private-content-mobile">
					<div class="py-2 text-center text-md-left">
						@if($empresa->facebook_url)
							<a class="social-icon" href="{{ $empresa->facebook_url }}" target="_blank" aria-label="Facebook">
								<svg class="icon-inline icon-lg"><use xlink:href="#facebook-f"></use></svg>
							</a>
						@endif
						@if($empresa->instagram_url)
							<a class="social-icon" href="{{ $empresa->instagram_url }}" target="_blank" aria-label="Instagram">
								<svg class="icon-inline icon-lg"><use xlink:href="#instagram"></use></svg>
							</a>
						@endif
						@if($empresa->twitter_url)
							<a class="social-icon" href="{{ $empresa->twitter_url }}" target="_blank" aria-label="Twitter">
								<svg class="icon-inline icon-lg"><use xlink:href="#twitter"></use></svg>
							</a>
						@endif
						@if($empresa->whatsapp)
							<a class="social-icon" href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $empresa->whatsapp) }}" target="_blank" aria-label="WhatsApp">
								<svg class="icon-inline icon-lg"><use xlink:href="#whatsapp"></use></svg>
							</a>
						@endif
					</div>
				</div>
