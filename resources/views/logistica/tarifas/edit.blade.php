<x-app-layout>
    <x-slot name="header">Editar Tarifa</x-slot>
                ...
                <div class="p-6">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="text-2xl font-semibold mb-0">
                            <i class="bi bi-cash-coin text-success me-2"></i>Editar: {{ $tarifa->nombre }}
                        </h4>
                    ...
                    <form action="{{ route('logistica.tarifas.update', $tarifa->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('zona_cobertura_id') is-invalid @enderror"
                                    ...
                                    @foreach($zonas as $zona)
                                        <option value="{{ $zona->id }}" {{ old('zona_cobertura_id', $tarifa->zona_cobertura_id) == $zona->id ? 'selected' : '' }}>
                                            {{ $zona->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('costo_base') is-invalid @enderror"
                                           id="costo_base" name="costo_base"
                                           value="{{ old('costo_base', $tarifa->costo_base) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('minimo_compra') is-invalid @enderror"
                                           id="minimo_compra" name="minimo_compra"
                                           value="{{ old('minimo_compra', $tarifa->minimo_compra) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('tiempo_entrega_horas') is-invalid @enderror"
                                           ...
                                           value="{{ old('tiempo_entrega_horas', $tarifa->tiempo_entrega_horas) }}"
                                           min="1" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{ old('costo_si_no_alcanza_minimo', $tarifa->costo_si_no_alcanza_minimo) }}"
                                           min="0" step="100">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{ old('costo_por_km', $tarifa->costo_por_km) }}"
                                           min="0" step="100">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="envio_gratis_desde"
                                                           ...
                                                           {{ old('envio_gratis_desde', $tarifa->envio_gratis_desde) ? 'checked' : '' }}
                                            ...
                                            <div class="col-md-6" id="monto_gratis_container" style="{{ old('envio_gratis_desde', $tarifa->envio_gratis_desde) ? '' : 'display: none;' }}">
                                                <label for="monto_envio_gratis" class="form-label">Monto para Envio Gratis</label>
                                                <div class="input-group">
                                                    <span class="input-group-text">$</span>
                                                    <input type="number" class="form-control"
                                                           id="monto_envio_gratis" name="monto_envio_gratis"
                                                           value="{{ old('monto_envio_gratis', $tarifa->monto_envio_gratis) }}"
                                                           min="0" step="1000">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg me-1"></i> Actualizar Tarifa
                            </button>
