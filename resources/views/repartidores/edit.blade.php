<x-app-layout>
    <x-slot name="header">Editar Repartidor</x-slot>
                ...
                <div class="p-6">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="text-2xl font-semibold mb-0">
                            <i class="bi bi-truck text-primary me-2"></i>Editar Repartidor
                        </h4>
                    ...
                    <form action="{{ route('repartidores.update', $repartidor) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('documento') is-invalid @enderror"
                                       id="documento" name="documento" value="{{ old('documento', $repartidor->documento) }}">
                                @error('documento')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select @error('vehiculo') is-invalid @enderror"
                                    ...
                                    <option value="moto" {{ old('vehiculo', $repartidor->vehiculo) == 'moto' ? 'selected' : '' }}>Moto</option>
                                    <option value="bicicleta" {{ old('vehiculo', $repartidor->vehiculo) == 'bicicleta' ? 'selected' : '' }}>Bicicleta</option>
                                    <option value="carro" {{ old('vehiculo', $repartidor->vehiculo) == 'carro' ? 'selected' : '' }}>Carro</option>
                                    <option value="a_pie" {{ old('vehiculo', $repartidor->vehiculo) == 'a_pie' ? 'selected' : '' }}>A pie</option>
                                </select>
                                @error('vehiculo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control @error('placa') is-invalid @enderror"
                                       id="placa" name="placa" value="{{ old('placa', $repartidor->placa) }}"
                                       placeholder="ABC-123">
                                @error('placa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('notas') is-invalid @enderror"
                                          ...
                                          placeholder="Observaciones adicionales...">{{ old('notas', $repartidor->notas) }}</textarea>
                                @error('notas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="activo" name="activo" value="1"
                                           {{ old('activo', $repartidor->activo) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg me-1"></i> Actualizar Repartidor
                            </button>
